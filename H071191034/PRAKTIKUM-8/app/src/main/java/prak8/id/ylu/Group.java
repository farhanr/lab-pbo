...
public class Group extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        kelompok = new Label("PILIH KELOMPOK");
        kelompok.setFont(Font.font("Gill Sans", FontWeight.BOLD, 20));
        kelompok.setTextFill(Color.web("#3246a8"));

        data = new Label("ISI DATA");
        data.setFont(Font.font("Gill Sans", FontWeight.BOLD, 20));
        data.setTextFill(Color.web("#3246a8"));

        VBox vBox = new VBox();
        vBox.getChildren().add(kelompok);
        vBox.setAlignment(Pos.CENTER);
        // vBox.setStyle("-fx-background-color: #b1bae6;");
        
        VBox vBox2 = new VBox();
        vBox2.getChildren().add(data);
        vBox2.setAlignment(Pos.CENTER);
        // vBox2.setStyle("-fx-background-color: #b1bae6;");
        ...
        radioButton1.setFont(Font.font("Century Gothic", 15));
        radioButton2.setToggleGroup(toogleKelompok);
        radioButton2.setFont(Font.font("Century Gothic", 15));
        radioButton3.setToggleGroup(toogleKelompok);
        radioButton3.setFont(Font.font("Century Gothic", 15));
        radioButton4.setToggleGroup(toogleKelompok);
        radioButton4.setFont(Font.font("Century Gothic", 15));
        ...
        gridPane.setStyle("-fx-background-color: #b1bae6;");
        // kanan
        ...
        gridPane2.setStyle("-fx-background-color: #b1bae6;");
        // var ref = new Object(){
        ...
        btnSave.setFont(Font.font("Century Gothic", FontWeight.EXTRA_BOLD, 15));
        btnSave.setStyle("-fx-text-fill: #ffffff; -fx-body-color: #c74248;");
